        ...
        <main class="main-content">
            ...
            <div class="container archived-page">
                ...
                <div class="sub-nav-tabs">
                    ...
                    <a href="${pageContext.request.contextPath}/owner/view-archived-staff" class="active">Archived Staff</a>
                ...
                <section class="archived-card">
                    ...
                    <div class="archived-header">
                        <div>
                            ...
                            <p>
                                Staff accounts that have been changed to INACTIVE.
                            </p>
                        </div>

                        <span class="count-badge">
                            <%= archivedStaffList == null
                                    ? 0
                                    : archivedStaffList.size() %>
                        </span>
                    </div>
                    ...
                    <% if (archivedStaffList != null
                            && !archivedStaffList.isEmpty()) { %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form class="restore-form"
                                                  method="post"
                                                  action="${pageContext.request.contextPath}/owner/restore-staff">
