...
<%
    List<Staff> archivedStaffList = (List<Staff>) request.getAttribute("archivedStaffList");
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Archived Staff | Cuti Murah Melaka</title>
    ...
    <style>
        ...
        .staff-id { color: #123a30; font-weight: 800; }
        ...
        <main class="main-content">
            <div class="container archived-page">
                ...
                <div class="sub-nav-tabs">
                    ...
                    <a href="${pageContext.request.contextPath}/staff/archived-staff" class="active">Archived Staff</a>
                ...
                <section class="archived-card">
                    <div class="archived-header">
                        <div>
                            ...
                            <p>Staff accounts that have been changed to INACTIVE.</p>
                        </div>
                        <span class="count-badge"><%= archivedStaffList == null ? 0 : archivedStaffList.size() %></span>
                    </div>

                    <% if (archivedStaffList != null && !archivedStaffList.isEmpty()) { %>
                        <div class="table-wrapper">
                            <table class="archived-table">
                                ...
                                <tbody>
                                <% for (Staff staff : archivedStaffList) { %>
                                    <tr>
                                        ...
                                        <td><span class="status-badge"><%= staff.getStatus() %></span></td>
                    ...
                    <% } else { %>
                        <div class="empty-message">No archived staff found.</div>
                    <% } %>
                </section>
            </div>
        </main>
